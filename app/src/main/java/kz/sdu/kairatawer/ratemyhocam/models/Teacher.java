...
public class Teacher {
    ...
    private float rating, ratingOverall;

    public Teacher() {
    }

    public Teacher(String name, String position, String image, int facultyId, float rating, int ratingCount, float ratingOverall) {
        this.name = name;
